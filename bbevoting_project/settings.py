...
# MIGHAgEAMBMGByqGSM49AgEGCCqGSM49AwEHBG0wawIBAQQgImId00C4/Q346JA4
# oDtwLJ45yIMV+a+Dyx0G6Qe
# -----END PUBLIC KEY-----"""
print(os.path.join(BASE_DIR,"bbevoting_project"",demo_public.pem"))
PUBLIC_KEY = open(os.path.join(BASE_DIR,"bbevoting_project","demo_public.pem"),"rt").read()
# PUZZLE
PUZZLE = '000000' # or more zeros
PLENGTH = len(PUZZLE)
